...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo"
             onclick="location.href='${pageContext.request.contextPath}/admin/gologin'" draggable="false">
        <ul class="text_13 f_right">
            <li>
                <a href="#" target="_self">首页</a>
            </li>
            <li class="nav_down">
                高端课程<img src="${pageContext.request.contextPath}/img/nav_down.png" alt="啊哦...图片走丢了" draggable="false">
            ...
            <li id="gkk" class="nav_choose">
                <a href="${pageContext.request.contextPath}/course/course/1">在线公开课</a>
            </li>
            <li>
                <a href="#">专家师资</a>
            </li>
